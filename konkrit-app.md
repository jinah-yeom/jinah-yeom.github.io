...
- **스크린 레이아웃:** 4열 트랙 유지, 그룹별 장수만큼 좌측부터 채움(3장 / 2장 / 2장, 빈 칸 허용). 세 그룹의 스크린 폭이 동일하게 유지되는 것이 우선. 세로 비율(약 9:19) 7장 전부 통일, 디바이스 프레임 유무도 통일. 모바일 2열 강등. 세부 값은 구현 스카우트 후 제안받아 확정.
