...
const PROBLEMS: ProblemBlockProps[] = [
  {
    headline: "리스트가 키퍼의 판단을 돕지 못했습니다",
    paragraphs: [
...
const SOLUTIONS: SolutionBlockProps[] = [
  {
    headline: "탐색의 시작을 날짜 선택으로 바꿨습니다",
    paragraphs: [
  ...
  {
    headline: "여러 유형을 한 번에 묶어 거르도록 업무 필터를 다시 설계했습니다",
    paragraphs: [
  ...
  {
    headline: "판단에 중요한 정보가 먼저 보이도록 카드를 다시 설계했습니다",
    paragraphs: [
...
export default function KeeperListviewPage() {
  return (
    <div className="flex flex-col gap-[var(--space-900)]">
      ...
      <ProseSection
        eyebrow="BACKGROUND"
        headline="키퍼는 리스트에서 하루의 일을 고릅니다"
      ...
      <ProseSection
        ...
        headline="조건에 맞는 업무가 없을 때도 탐색이 끊기지 않습니다"
        paragraphs={[
      ...
      <ProseSection
        ...
        headline="정책 문서와 화면 단위 PRD로 해석 차이를 없앴습니다"
        paragraphs={[
