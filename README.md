...
| 콘텐츠 UX 케이스 | [위시빈 여행기 UX 개선](https://jinah-yeom.github.io/work/wishbeen) — 여행기 상세를 거점으로 읽기와 탐색이 한 화면에서 이어지도록 재설계 |
...
실무 프로젝트의 화면과 데이터는 포트폴리오 목적에 맞게 더미 데이터로 재구성하며, 고객 정보 · 개인정보 · 운영 데이터는 포함하지 않습니다. 협업 과정 자료(PR 리뷰 등)는 설명에 필요한 최소 범위로만 제시합니다.
